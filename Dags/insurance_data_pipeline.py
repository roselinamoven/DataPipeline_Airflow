...
def read_csv_file():
    df = pd.read_csv('/Users/roselina/airflow/datasets/insurance.csv')
    print(df)
    return df.to_json()
...
def groupby_smoker(ti):
    ...
    smoker_df.to_csv(
        '/Users/roselina/airflow/output/grouped_by_smoker.csv', index=False)
...
def groupby_region(ti):
    ...
    region_df.to_csv(
        '/Users/roselina/airflow/output/grouped_by_region.csv', index=False)
